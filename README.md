...
[![Automation](https://github.com/ghostwriter/database/actions/workflows/automation.yml/badge.svg)](https://github.com/ghostwriter/database/actions/workflows/automation.yml)
[![PHP Version](https://badgen.net/packagist/php/ghostwriter/database?color=777BB4)](https://www.php.net/supported-versions)
[![Packagist Downloads](https://badgen.net/packagist/dt/ghostwriter/database?color=F28D1A)](https://packagist.org/packages/ghostwriter/database)
...
[![Sponsors via GitHub](https://img.shields.io/github/sponsors/ghostwriter?label=Sponsor+@ghostwriter/database&logo=GitHub+Sponsors)](https://github.com/sponsors/ghostwriter)
...
``` bash
composer require ghostwriter/database
```
...
- [All Contributors](https://github.com/ghostwriter/database/contributors)
